...
function ArchivedCalls() {
  ...
  if (archivedDisplayed.length === 0) {
    return (
      <EmptyView icon={<Icons.archiveX size={40} />} title="No archived calls" />
    );
  }
  ...
  return (
    <div className="flex flex-col space-y-6 p-4 relative">
      ...
      />
      <StickyActionBar>
        <Button type={BUTTON_TYPES.PRIMARY} cta="Restore all calls" icon={<Icons.archiveRestore />} onClick={() => openConfirm()} />
      </StickyActionBar>
